const es = {
  ...
  setup: {
    ...
    preferencesAreaBody: 'Idioma, tema y espacio inicial ahora pertenecen a quien inicia sesión, no a todo el negocio.',
    ...
    appearance: 'Apariencia',
    appearanceHelp: 'Los controles globales del tema deben seguir disponibles, pero la elección más completa pertenece a configuración y no al encabezado.',
  ...
  preferences: {
    ...
    title: 'Preferencias',
    description: 'Mantén livianos los valores personales: idioma, tema y qué espacio debe recibir primero a esta persona.',
