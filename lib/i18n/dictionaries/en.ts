const en = {
  ...
  roles: {
    owner_admin: { label: 'Owner admin' },
    shift_lead: { label: 'Shift lead' },
  ...
  theme: {
    ...
    optionsAria: 'Appearance options',
    appearance: 'Appearance',
    quickSwitch: 'Quick switch. Full controls stay in preferences.',
    quickSwitchHeader: 'Quick switch in user menu',
    groupAria: 'Appearance preference',
    light: {
      label: 'Light',
      shortLabel: 'Light',
      description:
  ...
  timeline: {
    ...
    overdue: 'Overdue',
    remainingHint: '{{count}} still pending',
    readyHint: 'Ready',
    readyPickupHint: 'Ready for pickup',
    readyDispatchHint: 'Ready for dispatch',
    assignmentNeededHint: 'Assignment needed',
    changedHint: 'Changed in kitchen',
    recurringHint: 'Recurring rhythm',
    ...
    summary: {
      ...
      pickupReadyHelp: 'focus-day pickup orders already finished and waiting',
  ...
  customers: {
    workspace: 'Customer memory',
    title: 'Customers',
    description:
      'Keep practical customer memory close to order-taking, fulfillment, and handoff without turning SKOSS into a sales CRM.',
    summary: 'customers',
    ...
    stats: {
      ...
      inactiveHelp: 'kept for memory and history',
      linkedOrders: 'Linked orders',
      linkedOrdersHelp: 'orders already tied to saved customer memory',
    },
    contactMethods: {
      phone: 'Phone',
      email: 'Email',
  ...
  setup: {
    ...
    import: {
      ...
      errors: {
        noColumns: 'No columns were found in this CSV file.',
        readFailed: 'The CSV file could not be read. Please try again.',
      },
    },
    ...
    actions: {
      ...
      importSuppliersCsv: 'Import suppliers CSV',
      importRawMaterialsCsv: 'Import materials CSV',
